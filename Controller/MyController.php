...
namespace Ez\ConferenceRestBundle\Controller;
...
//        $query->sortClauses = array( new Query\SortClause\DatePublished( Query::SORT_DESC ) );
        $query->sortClauses = array( new Query\SortClause\Field( "slot", "starting_time", Query::SORT_DESC, 'eng-GB' ));
